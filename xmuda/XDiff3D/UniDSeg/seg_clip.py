...
from xmuda.XDiff3D.UniDSeg.clip_vis_model import CLIPVisionTransformer
...
class SegCLIP(nn.Module):
    def __init__(self, backbone_2d=None):
        ...
        if backbone_2d == 'ViT-B-16':
            pretrained_dir = '/datanvme0/lifan/code/3D/pretrained/clip/ViT-B-16.pt'
            self.width = 768
            ...
            pretrained_dir = '/datanvme0/lifan/code/3D/pretrained/clip/ViT-L-14.pt'
            self.width = 1024
