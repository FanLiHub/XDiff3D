...
def test_VirtualKITTISCN():
    ...
    preprocess_dir = '/datanvme0/lifan/data/3D/virtual_kitti_intensity_preprocess/preprocess/'
    virtual_kitti_dir = '/datanvme0/lifan/data/3D/virtual_kitti'
    split = ('train',)
...
def compute_class_weights():
    preprocess_dir = 'virtual_kitti_preprocess/preprocess'
    split = ('train',)
